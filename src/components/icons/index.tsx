...
export const ShipIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SettingsIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  ...
  >
    ...
    <path d="M12 1v6m0 6v6m8.66-14.5l-5.2 3M8.54 14.5l-5.2 3m13.32 0l-5.2-3M8.54 9.5l-5.2-3" />
  </svg>
);
...
export const HandshakeIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    ...
    className={className}
  >
    <path d="M20 13V7a2 2 0 0 0-2-2h-2l-2-2H8L6 5H4a2 2 0 0 0-2 2v6" />
    <path d="M4 13v4a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-4" />
    <path d="m10 13-1.5 1.5a2 2 0 0 0 0 2.83L10 19l1.5-1.5a2 2 0 0 1 2.83 0L16 19l1.5-1.5a2 2 0 0 0 0-2.83L16 13" />
  </svg>
);
